...
var file_stream_proto_rawDesc = []byte{
	...
	0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x02, 0x70, 0x74, 0x32, 0xd9, 0x01, 0x0a, 0x0d, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x10, 0x53,
	...
	0x12, 0x43, 0x0a, 0x10, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x69, 0x64, 0x65, 0x53, 0x74,
	...
	0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x3e, 0x0a, 0x09, 0x42, 0x69, 0x64, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x12, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61,
...
var file_stream_proto_depIdxs = []int32{
	...
	1, // 2: proto.StreamService.ServerSideStream:input_type -> proto.StreamRequest
	1, // 3: proto.StreamService.ClientSideStream:input_type -> proto.StreamRequest
	1, // 4: proto.StreamService.BidStream:input_type -> proto.StreamRequest
	2, // 5: proto.StreamService.ServerSideStream:output_type -> proto.StreamResponse
	2, // 6: proto.StreamService.ClientSideStream:output_type -> proto.StreamResponse
	2, // 7: proto.StreamService.BidStream:output_type -> proto.StreamResponse
...
type StreamServiceClient interface {
	ServerSideStream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (StreamService_ServerSideStreamClient, error)
	ClientSideStream(ctx context.Context, opts ...grpc.CallOption) (StreamService_ClientSideStreamClient, error)
	BidStream(ctx context.Context, opts ...grpc.CallOption) (StreamService_BidStreamClient, error)
}
...
func (c *streamServiceClient) ServerSideStream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (StreamService_ServerSideStreamClient, error) {
...
func (x *streamServiceServerSideStreamClient) Recv() (*StreamResponse, error) {
...
func (x *streamServiceClientSideStreamClient) Send(m *StreamRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceClientSideStreamClient) CloseAndRecv() (*StreamResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(StreamResponse)
...
func (c *streamServiceClient) BidStream(ctx context.Context, opts ...grpc.CallOption) (StreamService_BidStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_StreamService_serviceDesc.Streams[2], "/proto.StreamService/BidStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &streamServiceBidStreamClient{stream}
	return x, nil
}

type StreamService_BidStreamClient interface {
	Send(*StreamRequest) error
	Recv() (*StreamResponse, error)
	grpc.ClientStream
}

type streamServiceBidStreamClient struct {
	grpc.ClientStream
}

func (x *streamServiceBidStreamClient) Send(m *StreamRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceBidStreamClient) Recv() (*StreamResponse, error) {
	m := new(StreamResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type StreamServiceServer interface {
	ServerSideStream(*StreamRequest, StreamService_ServerSideStreamServer) error
	ClientSideStream(StreamService_ClientSideStreamServer) error
	BidStream(StreamService_BidStreamServer) error
}
...
func (*UnimplementedStreamServiceServer) ServerSideStream(*StreamRequest, StreamService_ServerSideStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method ServerSideStream not implemented")
}
func (*UnimplementedStreamServiceServer) ClientSideStream(StreamService_ClientSideStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method ClientSideStream not implemented")
}
func (*UnimplementedStreamServiceServer) BidStream(StreamService_BidStreamServer) error {
...
func (x *streamServiceServerSideStreamServer) Send(m *StreamResponse) error {
...
func (x *streamServiceClientSideStreamServer) SendAndClose(m *StreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceClientSideStreamServer) Recv() (*StreamRequest, error) {
	m := new(StreamRequest)
...
func _StreamService_BidStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StreamServiceServer).BidStream(&streamServiceBidStreamServer{stream})
}

type StreamService_BidStreamServer interface {
	Send(*StreamResponse) error
	Recv() (*StreamRequest, error)
	grpc.ServerStream
}

type streamServiceBidStreamServer struct {
	grpc.ServerStream
}

func (x *streamServiceBidStreamServer) Send(m *StreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceBidStreamServer) Recv() (*StreamRequest, error) {
	m := new(StreamRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _StreamService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _StreamService_BidStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
